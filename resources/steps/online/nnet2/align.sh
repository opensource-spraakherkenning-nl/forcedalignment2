...
# This script has been modified to use the binary 'compile-train-graphs-fsts'
...
which compile-train-graphs-fsts
which nnet-align-compiled
which run.pl
which online2-wav-dump-features
...
$cmd JOB=1:$nj $dir/log/align.JOB.log \
  compile-train-graphs-fsts --read-disambig-syms=$lang/phones/disambig.int $dir/tree $srcdir/${iter}.mdl $lang/L_disambig.fst ark,t:$lang/G.fst.txt ark:- \| \
