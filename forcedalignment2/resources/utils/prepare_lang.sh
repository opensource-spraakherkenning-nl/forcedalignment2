...
echo PREPARE ZZZZZZ000000000000000000000
ls $srcdir/lexicon.txt
ls $srcdir/lexiconp.txt
...
echo PREPARE ZZZZZ1111111111111111111111111
cat $srcdir/lexicon.txt
echo PREPARE ZZZZZZ22222222222222222222222
cat $srcdir/lexiconp.txt
echo PREPARE ZZZZZZZZZZZZZZZZZZZZZZZ3333
...
echo PREPARE AAAAAAAAAAAAAAAAAAAA000
...
echo PREPARE AAAAAAAAAAAAAAAAAAAAAAA111
...
echo PREPARE LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL111
cat $dir/words.txt
echo PREPARE LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL222
...
echo PREPARE LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL333
cat $dir/words.txt
echo PREPARE LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL444
...
# louis: first write L.fst as text: L00.txt
if $silprob; then
  utils/make_lexicon_fst_silprob.pl $tmpdir/lexiconp_silprob.txt $srcdir/silprob.txt $silphone "<eps>" > $dir/L00.txt;
else
  utils/make_lexicon_fst.pl --pron-probs $tmpdir/lexiconp.txt $sil_prob $silphone > $dir/L00.txt;
fi

#echo XXXXXXXXXXXXXXX COPYING L.TXT XXXXXXXXXXXXXXXXXXXXXXXXXXXXX
#cp ~/L00.txt $dir/L00.txt

cat $dir/L00.txt |\
fstcompile --isymbols=$dir/phones.txt --osymbols=$dir/words.txt \
    --keep_isymbols=false --keep_osymbols=false | \
     fstarcsort --sort_type=olabel > $dir/L.fst
...
# louis: create L_disambig.txt
if $silprob; then
  utils/make_lexicon_fst_silprob.pl $tmpdir/lexiconp_silprob_disambig.txt $srcdir/silprob.txt $silphone '#'$ndisambig > $dir/L_disambig00.txt
else
  utils/make_lexicon_fst.pl --pron-probs $tmpdir/lexiconp_disambig.txt $sil_prob $silphone '#'$ndisambig > $dir/L_disambig00.txt
fi

# echo WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW COPYING L_DISAMBIG 
# cp ~/L_disambig00.txt $dir/L_disambig00.txt


cat $dir/L_disambig00.txt | \
fstcompile --isymbols=$dir/phones.txt --osymbols=$dir/words.txt \
     --keep_isymbols=false --keep_osymbols=false |   \
